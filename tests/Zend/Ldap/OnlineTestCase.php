...
abstract class Zend_Ldap_OnlineTestCase extends Zend_Ldap_TestCase
{
    ...
    {
        $this->_nodes = array(
            $this->_createDn('ou=Node,')          => array('objectClass' => 'organizationalUnit', 'ou' => 'Node', 'postalCode' => '1234'),
            $this->_createDn('ou=Test1,ou=Node,') => array('objectClass' => 'organizationalUnit', 'ou' => 'Test1'),
            $this->_createDn('ou=Test2,ou=Node,') => array('objectClass' => 'organizationalUnit', 'ou' => 'Test2'),
            $this->_createDn('ou=Test1,')         => array('objectClass' => 'organizationalUnit', 'ou' => 'Test1', 'l' => 'e'),
            $this->_createDn('ou=Test2,')         => array('objectClass' => 'organizationalUnit', 'ou' => 'Test2', 'l' => 'd'),
            $this->_createDn('ou=Test3,')         => array('objectClass' => 'organizationalUnit', 'ou' => 'Test3', 'l' => 'c'),
            $this->_createDn('ou=Test4,')         => array('objectClass' => 'organizationalUnit', 'ou' => 'Test4', 'l' => 'b'),
            $this->_createDn('ou=Test5,')         => array('objectClass' => 'organizationalUnit', 'ou' => 'Test5', 'l' => 'a'),
        );
